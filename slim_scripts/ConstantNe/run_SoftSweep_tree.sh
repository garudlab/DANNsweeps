...
#outFile=MSfiles/PFmedNsHigh500Kb/SoftSweep_${Ne}_H${H}_THETA${adaptive_theta}_Q${Q}_450Kb_${id}.txt
outFile=MSfiles/s0.01_0.1_THETA_1to5/SoftSweep_${Ne}_THETAvary_Q${Q}_450Kb_${id}.txt

for i in `seq 1 4000`; do #2500

	#get slim command 

	python slim_parametersSoftSweep.py ${Ne} ${id} ${i} ${Q} slim > ${file}_var
